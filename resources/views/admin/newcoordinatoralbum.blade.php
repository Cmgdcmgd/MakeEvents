                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header align-items-center d-flex">
                                <h4 class="card-title mb-0 flex-grow-1">Add new album for {{$coordinator->coordinatorUser->first_name}}</h4>
                            </div><!-- end card header -->
                            <div class="card-body">
                                <div class="live-preview">
                                    <form action="/addcoordinatoralbum" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="row gy-4">
                                            ...
                                            <div class="col-xxl-12 col-md-6 text-center">
                                                ...
                                                <a href="/coordinatoralbumlist/{{$coordinator->coordinator_id}}"><button type="button" class="btn btn-danger waves-effect waves-light">Cancel</button></a>
                                            </div>
                                        </div>
                                    </form>
                                    <!--end row-->
